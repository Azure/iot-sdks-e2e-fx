...
ControlApi::ControlApi() {
	...
	std::shared_ptr<ControlApiControlWrapperStatsResource> spControlApiControlWrapperStatsResource = std::make_shared<ControlApiControlWrapperStatsResource>();
	this->publish(spControlApiControlWrapperStatsResource);
...
ControlApiControlWrapperStatsResource::ControlApiControlWrapperStatsResource()
{
	this->set_path("/control/wrapperStats/");
	this->set_method_handler("GET",
		std::bind(&ControlApiControlWrapperStatsResource::GET_method_handler, this,
			std::placeholders::_1));
}
...
void ControlApiControlWrapperStatsResource::GET_method_handler(const std::shared_ptr<restbed::Session> session) {
