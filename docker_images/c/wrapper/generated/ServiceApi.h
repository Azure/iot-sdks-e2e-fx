...
///
/// </remarks>
class  ServiceApiServiceConnectionIdSendC2dDeviceIdResource: public restbed::Resource
{
public:
	ServiceApiServiceConnectionIdSendC2dDeviceIdResource();
    virtual ~ServiceApiServiceConnectionIdSendC2dDeviceIdResource();
    void PUT_method_handler(const std::shared_ptr<restbed::Session> session);
};
