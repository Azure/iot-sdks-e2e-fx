...
///
/// </remarks>
class  DeviceApiDeviceCreateFromSymmetricKeyTransportTypeResource: public restbed::Resource
{
public:
	DeviceApiDeviceCreateFromSymmetricKeyTransportTypeResource();
    virtual ~DeviceApiDeviceCreateFromSymmetricKeyTransportTypeResource();
    void PUT_method_handler(const std::shared_ptr<restbed::Session> session);
};
...
///
/// </remarks>
class  DeviceApiDeviceConnectionIdStorageInfoForBlobResource: public restbed::Resource
{
public:
	DeviceApiDeviceConnectionIdStorageInfoForBlobResource();
    virtual ~DeviceApiDeviceConnectionIdStorageInfoForBlobResource();
    void GET_method_handler(const std::shared_ptr<restbed::Session> session);
};
...
///
/// </remarks>
class  DeviceApiDeviceConnectionIdBlobUploadStatusResource: public restbed::Resource
{
public:
	DeviceApiDeviceConnectionIdBlobUploadStatusResource();
    virtual ~DeviceApiDeviceConnectionIdBlobUploadStatusResource();
    void PUT_method_handler(const std::shared_ptr<restbed::Session> session);
};
