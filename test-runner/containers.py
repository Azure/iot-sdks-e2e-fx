...
node.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-node6"
node.host_port = 8080
...
friend.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-node6"
...
python.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-python36"
...
c.name = "c"
c.module_id = "cMod"
c.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-gcc"
...
csharp.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-csharp"
...
java.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-java8"
...
pythonpreview.lkg_image = os.environ["IOTHUB_E2E_REPO_ADDRESS"] + "/edge-e2e-pythonpreview"
