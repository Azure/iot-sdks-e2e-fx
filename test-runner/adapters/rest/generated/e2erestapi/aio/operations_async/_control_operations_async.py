...
class ControlOperations:
    """ControlOperations async operations.
    ...
    async def get_wrapper_stats(
        ...
        """
        # Construct URL
        url = self.get_wrapper_stats.metadata['url']
        ...
        return deserialized
    get_wrapper_stats.metadata = {'url': '/control/wrapperStats'}
