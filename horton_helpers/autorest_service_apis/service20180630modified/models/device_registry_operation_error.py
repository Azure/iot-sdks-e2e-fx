...
class DeviceRegistryOperationError(Model):
    ...
    :type error_code: str or ~service20180630modified.models.enum
    ...
    def __init__(self, device_id=None, error_code=None, error_status=None, module_id=None, operation=None):
