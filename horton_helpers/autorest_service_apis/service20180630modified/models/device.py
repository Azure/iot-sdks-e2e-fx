...
class Device(Model):
    ...
    def __init__(self, device_id=None, generation_id=None, etag=None, connection_state=None, status=None, status_reason=None, connection_state_updated_time=None, status_updated_time=None, last_activity_time=None, cloud_to_device_message_count=None, authentication=None, capabilities=None):
