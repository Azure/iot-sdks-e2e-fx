...
class JobResponse(Model):
    ...
    :type cloud_to_device_method:
     ~service20180630modified.models.CloudToDeviceMethod
    :param update_twin:
    :type update_twin: ~service20180630modified.models.Twin
    ...
    :type device_job_statistics:
     ~service20180630modified.models.DeviceJobStatistics
    """
    ...
    def __init__(self, job_id=None, query_condition=None, created_time=None, start_time=None, end_time=None, max_execution_time_in_seconds=None, type=None, cloud_to_device_method=None, update_twin=None, status=None, failure_reason=None, status_message=None, device_job_statistics=None):
